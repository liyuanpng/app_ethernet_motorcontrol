...
#pragma ordered
        ...
        case c_adc_1 :> command:
            if(command == ADC_EXTERNAL_POT){
                master
                {
                c_adc_1 <: adc_data_a[3];
                c_adc_1 <: adc_data_b[3];
                }
            }

            else if (command == ADC_CURRENT_REQ)
            {
                master
                {
                    c_adc_1 <: adc_data_a[4];
                    c_adc_1 <: adc_data_b[4];
                }
